     ...
     <table class="table table-bordered table-hover">
         ...
         <tbody>
             ...
             <?php
                    ...
                    $send_comment_query = mysqli_query($conection, $query);


                    $count_query = mysqli_num_rows($send_comment_query);

                    echo "<td><a href='post_comments.php?id=$post_id'>$count_query</a></td>";
 ...
 <?php
    ...
    if (isset($_GET['reset'])) {
        ...
        $query = "UPDATE postes SET post_views_count = 0 WHERE post_id =" . mysqli_real_escape_string($conection, $_GET['reset']) . " ";
